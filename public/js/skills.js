...
$(document).ready(function () {
  ...
  $('table#assessments-table input[type=number]').change(function () {
    ...
    checkAssessment(this, pObj); // Get input object for average and total average
    ...
    avgPObj = $(avgObj).closest('td').find('.input-group-text'); // Change background color of average input

    checkAssessment(avgObj, avgPObj); // Caculate total average
    ...
    $.ajax({
      ...
      success: function success(response) {
        // Show message
        showMessage('success', 'Assessment (SID: ' + sId + ', Date: ' + aDate + ') was saved successfully!'); // Save average
