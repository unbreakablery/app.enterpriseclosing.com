<form class="form-inline mt-4" action="{{ route('tasks.add') }}" method="POST" autocomplete="off">
		...
		<table class="table table-hover datatable w-100" id="table-2">
			...
			<tbody>
				...
				<tr class="{{ $class_name }}">
					...
					<td class="text-center">
						<button type="button" class="btn btn-sm btn-success btn-done" data-id="{{ $task['id'] }}">Done</button>
						<button type="button" class="btn btn-sm btn-dark btn-skip" data-id="{{ $task['id'] }}">Skip</button>
					</td>
				</tr>
				@endforeach
			</tbody>
	...
	<div class="row task-section col-md-12 col-sm-12 mb-4" id="ts-1">
		<div class="form-check col-md-3 col-sm-3">
			<input class="form-check-input" type="radio" name="action" id="ts-1-rg-add" value="Add">
		...
		<div class="form-check col-md-3 col-sm-3">
			...
			<input type="text" class="form-control" aria-label="Text input with radio button" placeholder="Other" name="ts-1-other" id="ts-1-other">
		</div>
	</div>
	...
	<div class="row task-section col-md-12 col-sm-12 mb-4" id="ts-2">
		<div class="form-check col-md-3 col-sm-3">
			<input class="form-check-input" type="radio" name="step" id="ts-2-rg-account" value="Account">
		...
		<div class="form-check col-md-3 col-sm-3">
			...
			<input type="text" class="form-control" aria-label="Text input with radio button" placeholder="Other" name="ts-2-other" id="ts-2-other">
		</div>
	</div>

	<div class="row task-section col-md-12 col-sm-12 mb-4">
		<div class="col-md-3 col-sm-3 n-p-lr mb-4" id="ts-3">
			<h3>From / To / Account</h3>
			<div class="row task-section col-md-12 col-sm-12">
				<div class="input-group">
					<input type="text" class="form-control mr-task-input" aria-label="From / To / Account" id="ts-3-from-to" name="from-to-account" placeholder="From / To / Account...">
				</div>
			</div>
		</div>
		<div class="col-md-3 col-sm-3 n-p-lr mb-4" id="ts-6">
			<h3>Opportunity</h3>
			<div class="row task-section col-md-12 col-sm-12">
				<div class="input-group">
					<input type="text" class="form-control mr-task-input" placeholder="Opportunity..." aria-label="Opportunity" aria-describedby="ts-6-opportunity" name="opportunity">
				</div>
			</div>
		</div>
		<div class="col-md-3 col-sm-3 n-p-lr mb-4" id="ts-4">
			<h3>By</h3>
			<div class="row task-section col-md-12 col-sm-12">
				<div class="input-group">
					<input type="text" class="form-control date mr-task-input" aria-label="By Date" id="ts-4-by-date" name="by-date" placeholder="dd-mm-yyyy">
				</div>
			</div>
		</div>
		<div class="col-md-3 col-sm-3 n-p-lr mb-4" id="ts-7">
			<h3>Priority</h3>
			<div class="row task-section col-md-12 col-sm-12">
				<div class="form-check col-md-12 col-sm-12 mr-4">
					<input class="form-check-input" type="radio" name="priority" id="ts-7-rg-high" value="1">
